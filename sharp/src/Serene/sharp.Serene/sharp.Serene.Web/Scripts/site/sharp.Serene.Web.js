...
(function (sharp) {
    ...
    })(Serene = sharp.Serene || (sharp.Serene = {}));
})(sharp || (sharp = {}));
var sharp;
(function (sharp) {
    var Serene;
...
(function (sharp) {
    ...
    (function (Serene) {
        ...
        (function (Northwind) {
            ...
            Serenity.Decorators.registerEnum(Gender, 'sharp.Serene.Northwind.Entities.Gender');
        })(Northwind = Serene.Northwind || (Serene.Northwind = {}));
    })(Serene = sharp.Serene || (sharp.Serene = {}));
})(sharp || (sharp = {}));
var sharp;
                ...
                OrderGrid.prototype.onClick = function (e, row, cell) {
                    ...
                    if (target.hasClass('inline-action')) {
                        ...
                        if (target.hasClass('print-invoice')) {
                            sharp.Serene.Common.ReportHelper.execute({
        ...
        (function (Northwind) {
            var OrderDialog = (function (_super) {
                ...
                OrderDialog.prototype.getToolbarButtons = function () {
                    var _this = this;
                    var buttons = _super.prototype.getToolbarButtons.call(this);
                    buttons.push(sharp.Serene.Common.ReportHelper.createToolButton({
                        title: 'Invoice',
            ...
            var SerialAutoNumberDialog = (function (_super) {
                ...
                SerialAutoNumberDialog.prototype.getNextNumber = function () {
                    ...
                    if (!val || val.length <= 1) {
                        ...
                        sharp.Serene.Northwind.CustomerService.GetNextNumber({
                            Prefix: prefix,
        ...
        (function (Northwind) {
            var CustomerGrid = (function (_super) {
                ...
                CustomerGrid.prototype.getButtons = function () {
                    var _this = this;
                    var buttons = _super.prototype.getButtons.call(this);
                    buttons.push(sharp.Serene.Common.ExcelExportHelper.createToolButton({
                        grid: this,
                        onViewSubmit: function () { return _this.onViewSubmit(); },
                        service: 'Northwind/Customer/ListExcel',
                        separator: true
                    }));
                    buttons.push(sharp.Serene.Common.PdfExportHelper.createToolButton({
                        grid: this,
                        onViewSubmit: function () { return _this.onViewSubmit(); }
                    }));
                    return buttons;
...
//# sourceMappingURL=sharp.Serene.Web.js.map